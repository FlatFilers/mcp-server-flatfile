...
import { spaces_SpaceConfigSchema } from '../schemas.js'
...
export const createSpace: Tool<typeof params> = {
  name: 'createSpace',
  description: 'Create a space: Creates a new space based on an existing Space Config',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

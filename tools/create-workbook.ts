...
import { workbooks_CreateWorkbookConfigSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: workbooks_CreateWorkbookConfigSchema,
} as ZodRawShape

export const createWorkbook: Tool<typeof params> = {
  name: 'createWorkbook',
  description: 'Create a workbook: Creates a workbook and adds it to a space',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

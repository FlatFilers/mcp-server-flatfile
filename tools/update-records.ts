...
import { commons_SheetIdSchema, records_RecordsSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  sheetId: commons_SheetIdSchema.describe('ID of sheet'),
  body: records_RecordsSchema,
} as ZodRawShape

export const updateRecords: Tool<typeof params> = {
  name: 'updateRecords',
  description: 'Update records: Updates existing records in a workbook sheet',
  params,

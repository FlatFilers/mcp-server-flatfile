...
export const failJob: Tool<typeof params> = {
  name: 'failJob',
  description: 'Fail a job: Fail a job and return the job',
  params,
  cb: async ({ jobId, body }) => {
    try {
      const searchParams = {}
      ...
      const url = `${baseUrl}/jobs/${jobId}/fail${searchParamsString ? `?${searchParamsString}` : ''}`

...
export const deleteAllHistoryForUserMapping: Tool<typeof params> = {
  name: 'deleteAllHistoryForUserMapping',
  description: 'Delete all history for the authenticated user: Deletes all history for the authenticated user',
  params,

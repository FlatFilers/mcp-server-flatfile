...
import { commons_SheetIdSchema, records_RecordDataSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  sheetId: commons_SheetIdSchema.describe('ID of sheet'),
  body: z.array(records_RecordDataSchema),
} as ZodRawShape

export const insertRecords: Tool<typeof params> = {
  name: 'insertRecords',
  description: 'Insert records: Adds records to a workbook sheet',
  params,

...
import { commons_JobIdSchema, jobs_JobCompleteDetailsSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  jobId: commons_JobIdSchema.describe('ID of job to return'),
  body: jobs_JobCompleteDetailsSchema.optional(),
} as ZodRawShape

export const completeJob: Tool<typeof params> = {
  name: 'completeJob',
  description: 'Complete a job: Complete a job and return the job',
  params,
  cb: async ({ jobId, body }) => {
    try {
      const searchParams = {}
      ...
      const url = `${baseUrl}/jobs/${jobId}/complete${searchParamsString ? `?${searchParamsString}` : ''}`

...
import { assistant_PromptCreateSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: assistant_PromptCreateSchema,
} as ZodRawShape

export const createAssistant: Tool<typeof params> = {
  name: 'createAssistant',
  description: 'Create a prompt: Creates a prompt',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

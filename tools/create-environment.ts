...
import { environments_EnvironmentConfigCreateSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: environments_EnvironmentConfigCreateSchema,
} as ZodRawShape

export const createEnvironment: Tool<typeof params> = {
  name: 'createEnvironment',
  description: 'Create an environment: Create a new environment',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

...
import { commons_ProgramIdSchema, mapping_UpdateMappingRulesRequestSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  programId: commons_ProgramIdSchema.describe('ID of the program'),
  body: mapping_UpdateMappingRulesRequestSchema,
} as ZodRawShape

export const updateRulesMapping: Tool<typeof params> = {
  name: 'updateRulesMapping',
  description: 'Update a list of mapping rules: Updates a list of mapping rules in a program',
  params,

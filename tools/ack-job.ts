...
import { commons_JobIdSchema, jobs_JobAckDetailsSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  jobId: commons_JobIdSchema.describe('ID of job to return'),
  body: jobs_JobAckDetailsSchema.optional(),
} as ZodRawShape

export const ackJob: Tool<typeof params> = {
  name: 'ackJob',
  description: 'Acknowledge a job: Acknowledge a job and return the job',
  params,
  cb: async ({ jobId, body }) => {
    try {
      const searchParams = {}
      ...
      const url = `${baseUrl}/jobs/${jobId}/ack${searchParamsString ? `?${searchParamsString}` : ''}`

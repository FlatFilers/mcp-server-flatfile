...
import { commons_JobIdSchema, jobs_JobCancelDetailsSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  jobId: commons_JobIdSchema.describe('ID of job to return'),
  body: jobs_JobCancelDetailsSchema.optional(),
} as ZodRawShape

export const cancelJob: Tool<typeof params> = {
  name: 'cancelJob',
  description: 'Cancel a job: Cancel a job and return the job',
  params,
  cb: async ({ jobId, body }) => {
    try {
      const searchParams = {}
      ...
      const url = `${baseUrl}/jobs/${jobId}/cancel${searchParamsString ? `?${searchParamsString}` : ''}`

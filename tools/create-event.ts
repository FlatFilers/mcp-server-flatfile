...
import { events_CreateEventConfigSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: events_CreateEventConfigSchema,
} as ZodRawShape

export const createEvent: Tool<typeof params> = {
  name: 'createEvent',
  description: 'Create an event: Create an event',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

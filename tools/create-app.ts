...
import { apps_AppCreateSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: apps_AppCreateSchema,
} as ZodRawShape

export const createApp: Tool<typeof params> = {
  name: 'createApp',
  description: 'Create an app: Creates an app',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}
      ...
      const url = `${baseUrl}/apps${searchParamsString ? `?${searchParamsString}` : ''}`

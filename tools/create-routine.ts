...
import { routines_CreateRoutineRequestSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: routines_CreateRoutineRequestSchema,
} as ZodRawShape

export const createRoutine: Tool<typeof params> = {
  name: 'createRoutine',
  description: 'Create a routine: Creates a new routine',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}

...
import { apps_ConstraintCreateSchema, commons_AppIdSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  appId: commons_AppIdSchema.describe('ID of the app'),
  body: apps_ConstraintCreateSchema,
} as ZodRawShape

export const createConstraintApp: Tool<typeof params> = {
  name: 'createConstraintApp',
  description: 'Create constraint: Creates a new constraint for an app',
  params,
  cb: async ({ appId, body }) => {
    try {
      const searchParams = {}

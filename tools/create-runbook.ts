...
import { runbooks_CreateRunbookRequestSchema } from '../schemas.js'
import type { Tool } from './index.js'

const params = {
  body: runbooks_CreateRunbookRequestSchema,
} as ZodRawShape

export const createRunbook: Tool<typeof params> = {
  name: 'createRunbook',
  description: 'Create a runbook: Creates a new runbook',
  params,
  cb: async ({ body }) => {
    try {
      const searchParams = {}
